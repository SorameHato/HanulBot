...
class info(commands.Cog):
    ...
    async def on_message(self, message):
        if not message.author.bot:
            keywords = ['안녕','좋은아침','좋은 아침','좋은점심','좋은 점심','좋은저녁','좋은 저녁','좋은하루','좋은 하루', '쫀아', '좋은 밤', '좋은밤', '잘자', '잘 자', '쫀밤', '좋은 밤', '잘잤어', '잘 잤어', '쫀하루', '쫀점', '쫀저']
            responseList = ['안녕하세요! 좋은 하루에요!','에헤헤.. 쫀아에요!','좋은 점심이에요!','좋은 저녁이에요! 오늘 하루도 수고하셨어요!','안녕히 주무세요!','하늘봇은 24시간 여러분을 도와드리기 위해 깨어 있어요! 그치만 하늘봇을 개발하고 있는 하토는 다행히 잘 잔 것 같아요!']
            response = [0,1,1,2,2,3,3,0,0,1,3,3,4,4,4,4,5,5,0,2,3]
            reply = None
            notProper = False
